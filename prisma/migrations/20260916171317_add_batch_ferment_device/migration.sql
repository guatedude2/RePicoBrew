...
INSERT INTO "new_Batch" ("carbDuration", "carbExtendMinutes", "carbMethod", "carbStartedAt", "carbStatus", "carbUnit", "completedAt", "createdAt", "id", "name", "phase", "recipeId", "updatedAt") SELECT "carbDuration", "carbExtendMinutes", "carbMethod", "carbStartedAt", "carbStatus", "carbUnit", "completedAt", "createdAt", "id", "name", "phase", "recipeId", "updatedAt" FROM "Batch";
DROP TABLE "Batch";
